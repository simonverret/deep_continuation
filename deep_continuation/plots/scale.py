...
ax1.plot(X, S2, linewidth=1.5, c=COLORS[1], label=r"$s\sigma(s\omega  )  $")
ax1.plot(X, S1, linewidth=2.5, c=COLORS[0], label=r"$ \sigma( \omega  )  $")
ax1.plot(X, S3, linewidth=1.5, c=COLORS[3], label=r"$ \sigma( \omega/s)/s$")
ax1.set_xlabel(r"$\omega$")
ax1.legend(handlelength=1)
# ax1.text(0.03, 0.95, r'$\sigma(\omega)$', ha='left', va='top', transform=ax1.transAxes)

ax2.plot(W2, P12, '.', markersize=3+13, c=COLORS[0], label=r"$ \sigma( \omega  )  ,s\beta  $")
ax2.plot(W1, P11, '.', markersize=3+10, c=COLORS[0], label=r"$ \sigma( \omega  )  , \beta  $")
ax2.plot(W3, P13, '.', markersize=3+7, c=COLORS[0], label=r"$ \sigma( \omega  )  , \beta/s$")
ax2.plot(W2, P22, '.', markersize=3+7 , c=COLORS[1], label=r"$s\sigma(s\omega  )  ,s\beta  $")
ax2.plot(W1, P21, '.', markersize=3+4, c=COLORS[1], label=r"$s\sigma(s\omega  )  , \beta  $")
ax2.plot(W1, P31, '.', markersize=3+7 , c=COLORS[3], label=r"$ \sigma( \omega/s)/s, \beta  $")
ax2.plot(W3, P33, '.', markersize=3+4 , c=COLORS[3], label=r"$ \sigma( \omega/s)/s, \beta/s$")
# ax2.set_ylim(0,0.4)
...
ax3.plot(P12, '.', markersize=3+13, c=COLORS[0], label=r"$ \sigma( \omega  )  ,s\beta  $")
ax3.plot(P11, '.', markersize=3+10, c=COLORS[0], label=r"$ \sigma( \omega  )  , \beta  $")
ax3.plot(P13, '.', markersize=3+7, c=COLORS[0], label=r"$ \sigma( \omega  )  , \beta/s$")
ax3.plot(P22, '.', markersize=3+7 , c=COLORS[1], label=r"$s\sigma(s\omega  )  ,s\beta  $")
ax3.plot(P21, '.', markersize=3+4, c=COLORS[1], label=r"$s\sigma(s\omega  )  , \beta  $")
ax3.plot(P31, '.', markersize=3+7 , c=COLORS[3], label=r"$ \sigma( \omega/s)/s, \beta  $")
ax3.plot(P33, '.', markersize=3+4 , c=COLORS[3], label=r"$ \sigma( \omega/s)/s, \beta/s$")
# ax3.set_ylim(0,0.4)
ax3.set_xlabel(r"$n$")
